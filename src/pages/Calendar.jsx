...
const CATEGORY_COLORS = {
  ...
  Leave: {
    badge: "bg-orange-100 text-orange-500 border-orange-200",
    bar: "bg-orange-300",
    dot: "bg-orange-300",
  },
};
      ...
      <section className="container-narrow py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {sorted.map((event, i) => {
            ...
            const weekday = dateObj.toLocaleString("en-IN", {
              weekday: "short",
            });
                ...
                <div className="flex flex-col flex-1 p-5">
                  ...
                  <div className="flex items-start justify-between gap-3 mb-4">
                    ...
                    <div className="flex flex-col items-end gap-1.5 pt-0.5">
                      <span
                        className={`inline-block text-[10px] uppercase tracking-widest px-2.5 py-1 rounded-full border font-bold ${colors.badge}`}
                      >
                        {event.category}
                      </span>
      ...
      <section className="container-narrow pb-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-festive text-primary-foreground p-10 text-center shadow-temple ornate-frame">
          ...
          <div className="relative z-10">
            ...
            <h3 className="font-display text-3xl mb-2 font-bold">
              {t("cal.cta.title")}
            </h3>
